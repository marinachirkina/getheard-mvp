...
The user language is: ${language === 'ru' ? 'Russian' : 'English'}.
You MUST always respond in this language.
...
- ALWAYS ask in the user's language
...
`;
    ...
    try {
      ...
      return NextResponse.json({
        ...
        question:
          language === 'ru'
            ? 'Можете рассказать чуть подробнее о симптомах или самочувствии?'
            : 'Could you tell me a bit more about the health concern?',
      });
    }
  } catch (error) {
